      ...
      <main className="relative z-10">
        ...
        <section className="px-5 sm:px-8 lg:px-12 py-16 max-w-7xl mx-auto">
          <motion.div
            ...
            className="rounded-[36px] border border-white/10 bg-gradient-to-br from-white/[0.06] to-red-500/10 backdrop-blur-xl p-8 sm:p-10 overflow-hidden relative mb-16"
          >
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                {makerworldProjects.map((item, index) => (
                  <motion.a
                    ...
                    className="group rounded-3xl border border-white/10 bg-black/30 backdrop-blur-xl p-4 overflow-hidden relative"
                  >
